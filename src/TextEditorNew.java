...
public class TextEditorNew implements ActionListener {
    ...
    public void actionPerformed(ActionEvent actionEvent){
        ...
        if(actionEvent.getSource()==newFile){
            //Create a new editor
            TextEditorNew newWindow = new TextEditorNew(); // create a new texteditor with same properties
        }
    ...
    public static void main(String[] args) {
        TextEditorNew textEditor = new TextEditorNew();
    }
}